...
(function() {
  ...
  update_motivate = function() {
    ...
    if (motivate_timer <= 0 && motivate_bonus > 0) {
      motivate_bonus--;
      return motivate_timer = motivate_timer_max;
    }
  };
