...
(function() {
  var Crop, expenses, land_available, land_max, land_owned, money, net, num_tillers, potato, profit, time_tilling, time_tilling_increase, time_tilling_max, timer_step, update_financial_text, update_land, update_land_text, update_land_timing, update_money, update_profit, update_text, wage_driver, wage_farmer, wage_tiller;
  ...
  update_profit = function() {
    ...
    expenses = potato.num_farmers * wage_farmer + potato.num_drivers_max * wage_driver + +num_tillers * wage_tiller + potato.val_seed * potato.num_acres * 60 / time;
